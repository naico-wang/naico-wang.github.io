...
<!-- <div align="center">[img](https://latex.codecogs.com/gif.latex?delay=\frac{l(bit)}{v(bit/s)})</div> <br> -->
...
<!-- <div align="center">[img](https://latex.codecogs.com/gif.latex?delay=\frac{l(m)}{v(m/s)})</div> <br> -->
