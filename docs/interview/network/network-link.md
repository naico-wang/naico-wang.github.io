...
<!-- <div align="center">[img](https://latex.codecogs.com/gif.latex?\frac{1}{m}\vec{S}\cdot\vec{T}=0)</div> <br> -->
...
<!-- <div align="center">[img](https://latex.codecogs.com/gif.latex?\frac{1}{m}\vec{S}\cdot\vec{S}=1)</div> <br> -->
